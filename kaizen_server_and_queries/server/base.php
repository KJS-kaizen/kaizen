...
// }
$sql = "SELECT contents_id,contents_name FROM tbl_contents WHERE school_id = (SELECT school_id FROM tbl_admin WHERE admin_id = ".$isManager.") AND enable = 1;";
$result = $con->query($sql);
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
       array_push($contents_idToDisplay,$row["contents_id"]);
       array_push($contnents_nameToDisplay,$row["contents_name"]);
    }
}
$_POST['choicedata']=$contnents_nameToDisplay;
/*For mapping*/
$error_message = array();
...
if (filter_input(INPUT_POST, "submit") == "save") {
    //Sending Category Calculation
    $_SESSION['csvRowA'] = $csvRowA;
    $_SESSION['csvRowC'] = $csvRowC;
    $_SESSION['csvRowD'] = $csvRowD;
    $_SESSION['csvRowE'] = $csvRowE;
    $_SESSION['csvTree'] = $csvTree;
    // タイトル title
    ...
    // 合否判定の表示 Pass / fail judgment display
        ...
        <div id="col-quiz-control" class="clearfix">
            ...
            <div id="control-box-formgroup">
                ...
                <div class="body">
                    ...
                    <!-- 答案結果の表示 Display of answer results-->
