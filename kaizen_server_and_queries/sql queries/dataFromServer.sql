...
-- Dumping data for table kaizen.log_contents_history_student: ~68 rows (approximately)
...
-- Dumping data for table kaizen.log_contents_history_student_event: ~440 rows (approximately)
...
-- Dumping data for table kaizen.log_contents_history_student_event_reason: ~554 rows (approximately)
...
-- Dumping data for table kaizen.tbl_function_group: ~14 rows (approximately)
...
-- Dumping data for table kaizen.tbl_function_list: ~135 rows (approximately)
...
-- Dumping data for table kaizen.tbl_questionnaire: ~21 rows (approximately)
...
-- Dumping data for table kaizen.tbl_questionnaire_answer: ~7 rows (approximately)
...
-- Dumping data for table kaizen.tbl_questionnaire_answer_query: ~7 rows (approximately)
...
-- Dumping data for table kaizen.tbl_questionnaire_answer_query_multiple_choice: ~1 rows (approximately)
...
-- Dumping data for table kaizen.tbl_questionnaire_answer_query_single_choice: ~2 rows (approximately)
...
-- Dumping data for table kaizen.tbl_questionnaire_query: ~38 rows (approximately)
...
-- Dumping data for table kaizen.tbl_questionnaire_query_choices: ~102 rows (approximately)
...
-- Dumping data for table kaizen.tbl_quiz_answer_query: ~60 rows (approximately)
...
-- Dumping data for table kaizen.tbl_quiz_answer_query_choice: ~47 rows (approximately)
...
-- Dumping data for table kaizen.tbl_student: ~8 rows (approximately)
...
INSERT INTO `tbl_student` (`student_id`, `school_id`, `student_code`, `student_name`, `joining`, `id`, `password`, `access_code`, `access_datetime`, `bit_subject`, `enable`, `display_order`) VALUES
	(1, 1, '', 'kjsstudent1', 1, '8Cvpri/8lP0gwIq0rLiqFDFQV+13ItR/I2TBdnzKmek=', 'txB+mTpwwVqH3ASXoVzra0b8ZhZQ5NsUSER69tvfrPc=', NULL, '2019-12-26 07:48:11', '7', 1, 1),
	...
	(4, 1, '', 'tanjil', 1, '6UrhpgRDpjImCpCYftOuVA==', 'Z4QMwSaA9+u8Qo3lkhn9oQ==', NULL, '2019-12-26 04:43:23', '3', 1, 4),
