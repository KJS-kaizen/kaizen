...
-- Dumping data for table kaizen.tbl_function_list: ~102 rows (approximately)
...
-- Dumping data for table kaizen.tbl_quiz: ~38 rows (approximately)
...
-- Dumping data for table kaizen.tbl_quiz_answer: ~26 rows (approximately)
...
-- Dumping data for table kaizen.tbl_quiz_answer_query: ~62 rows (approximately)
...
-- Dumping data for table kaizen.tbl_quiz_answer_query_choice: ~51 rows (approximately)
...
INSERT INTO `tbl_student` (`student_id`, `school_id`, `student_code`, `student_name`, `joining`, `id`, `password`, `access_code`, `access_datetime`, `bit_subject`, `enable`, `display_order`) VALUES
	...
	(4, 1, '', 'tanjil', 1, '6UrhpgRDpjImCpCYftOuVA==', 'Z4QMwSaA9+u8Qo3lkhn9oQ==', NULL, '2019-12-13 11:56:47', '3', 1, 4),
