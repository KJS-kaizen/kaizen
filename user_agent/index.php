            ...
            <div class="card-body px-lg-5 pt-0 mt-sm-5">
                ...
                <form id="user_agent_form" action="thanks.php" onsubmit="return validation()" method="post"
                    ...
                    <p>
                        ...
                        <div class="md-form">
                            <label>
                                <h2><i class="fad fa-building fa-fw"></i> Company Name</h2>
                            </label>
                        ...
                        <label>
                          ...
                          <div class="d-flex justify-content-around">
                              <div>
                                  ...
                                  <a href="http://fast.com" target="_blank"><h4><i class="fad fa-external-link-alt fa-fw"></i> Click here to find out your Internet speed</h4></a>
                                  <p class="par-font">Note:After clicking the link above, Please wait some moments for getting the exact internet speed.</p>
                              </div>
                          </div>
                        </label>
                        <div class="row">
                ...
                <div class="alert alert-danger alert-font" style="display:none">
                    <button type="button" class="close d-none" aria-hidden="true">&times;</button>
